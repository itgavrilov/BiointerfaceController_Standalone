...
public class ExaminationService {
    ...
    public static ExaminationService getInstance() throws NoConnectionException {
        if (instance == null) {
    ...
    private ExaminationService() throws NoConnectionException {
    ...
    public void recordingStart(Examination entity) throws Exception {
        ...
        if (readEntity == null) {
            ...
            LOGGER.error("Examination(id={}) already exists in database. Recording is not start", entity.getId());
    ...
    public void delete(Examination entity) throws Exception {
        ...
        if(readEntity != null) {
            ...
            throw new EntityNotFoundException("Examination(id=" + entity.getId() + ") is not found in database");
        }
    }
