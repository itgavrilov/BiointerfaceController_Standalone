...
//        List<ChannelName> entities = service.findAll();
...
//
//        ChannelName entityTest = service.findById(entity.getId());
...
//        ChannelName entityTest = repository.findById(entity.getId());
//        Assertions.assertEquals(entity, entityTest);
//        repository.delete(entity);
//    }
//
...
//
//        entity.setId(idTest);
//        Assertions.assertEquals(entity, repository.findById(idTest));
//        service.delete(entity);
//        Assertions.assertNull(repository.findById(idTest));
//    }
//
//    @Test
